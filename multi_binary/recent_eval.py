...
for type_id in range(0, 8):
    multi_path = '/opt/ml/code/prediction/recent_data/depot-recent-%d.csv' % (type_id)
...
binary_predictions.to_csv('/opt/ml/code/prediction/recent/depot-recent-final_dasi.csv', index = False)
print('--------------------------------- finish! ----------------------------------')
