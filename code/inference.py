...
def main(cfg):
    ...
    ## load my model
    MODEL_NAME = cfg.model.saved_name # model dir.
    # model = AutoModelForSequenceClassification.from_pretrained(args.model_dir)
    model = AutoModelForSequenceClassification.from_pretrained(f'{cfg.path.best_model}/{cfg.model.saved_name}')
    model.parameters
    model.to(device)
...
if __name__ == '__main__':
    ...
    # model dir
    # parser.add_argument('--model_dir', type=str, default="./best_model/roberta-large")
